...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root='../../mmpretrain/data/fruit_dataset/train',
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root='../../mmpretrain/data/fruit_dataset/valid',
...
train_cfg = dict(by_epoch=True, max_epochs=max_epochs_cnt, val_interval=1)
val_cfg = dict()
test_cfg = dict()
